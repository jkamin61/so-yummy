            ...
            <div className="flex justify-center items-center">
                <form
                    ...
                    <input
                        ...
                        className="bg-transparent h-10 font-poppins border border-zinc-500 rounded bg-user bg-no-repeat pl-8 text-sm bg-left outline-0"
                        type="text"
                        placeholder="Name"/>
                    <input
                        style={{backgroundPosition: "10px 10px"}}
                    ...
                    <button className="h-10 w-full mt-2 bg-asparagus rounded font-poppins">Sign up</button>
                </form>
            </div>
